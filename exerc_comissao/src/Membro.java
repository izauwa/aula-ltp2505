public class Membro {
    ...
    public String toString() {
        // Ex: Servidor Nome do Servidor - BP12523-1
    ...
    private String formatarProntuario() {
        ...
        // 2. Extrair o último digito do prontuário
        ...
        // 4. Remover o último digito do prontuario 
        // que é String
        // Ex: IFSP.substring(0,3) -> Resultado: IFS
        prontuarioStr = prontuarioStr.substring(
                0, 
                prontuarioStr.length() - 1);
        // 5. Concatenar campus 
